...
const Experience = () => {
  const experiences = [
    {
      title: "AI Development Executive",
      company: "Khulna Technologies LLC",
      client: "Raju Law - US Immigration & Investment Attorneys",
              ...
              >
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="flex md:flex-col items-center md:items-start gap-4 md:gap-2 md:min-w-[200px]">
                    ...
                    <div
                      className={`p-4 bg-${exp.color}/10 rounded-lg group-hover:bg-${exp.color}/20 transition-colors`}
                    >
                      <Briefcase
                        className={`h-6 w-6 text-${exp.color}`}
                      />
                    </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 mb-1">
                      ...
                      {index === 0 && (
                        <span className="w-fit text-xs px-3 py-1 bg-primary/10 text-primary border border-primary/20 rounded-full font-medium">
                          Current Role
                        </span>
                      )}
